...
<form action="EditTestServlet" method="post">
    ...
    <label>
        <input type="checkbox" name="showAnswers" <%= request.getAttribute("showAnswers") != null && (Boolean) request.getAttribute("showAnswers") ? "checked" : "" %> />
            ...
            <div class="question">
                ...
                <div class="options-container" style="<%= questionTypes[i].equals("multiple_choice") ? "display: block;" : "display: none;" %>">
                    ...
                    %>
                        ...
                        <input type="text" name="options_<%= i %>_<%= j %>" value="<%= options[i][j] %>" /><br>
                    <% 
                        }
                    } 
                    %>
                    <label>Correct Answer (Option Number):</label>
                    <input type="text" name="correctAnswer_<%= i %>" value="<%= correctAnswers[i] %>" /><br>
                </div>

                    <div class="true-false-container" style="<%= questionTypes[i].equals("true_false") ? "display: block;" : "display: none;"%>">
                        <label>Correct Answer:</label>
                        <select name="correctAnswer_<%= i%>">
                            <option value="true" <%= "true".equals(correctAnswers[i]) ? "selected" : ""%>>True</option>
                            <option value="false" <%= "false".equals(correctAnswers[i]) ? "selected" : ""%>>False</option>
                        </select><br>
                    </div>
